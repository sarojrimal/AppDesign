...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_text_make = findViewById(R.id.e_make);
        edit_text_year = findViewById(R.id.e_year);
        edit_text_color = findViewById(R.id.e_color);
        edit_text_price = findViewById(R.id.e_price);
        edit_text_engine = findViewById(R.id.e_engine);
        text_view_details = findViewById(R.id.e_details);
    }
